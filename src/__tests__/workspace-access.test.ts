...
describe('getWorkspaceFromAppPath', () => {
  ...
  it('returns docs for /docs/invoices', () => expect(getWorkspaceFromAppPath('/docs/invoices')).toBe('docs'));
  it('returns docs for /invoice (legacy)', () => expect(getWorkspaceFromAppPath('/invoice')).toBe('docs'));
  it('returns os for /os/dashboard', () => expect(getWorkspaceFromAppPath('/os/dashboard')).toBe('os'));
...
describe('getWorkspaceFromApiPath', () => {
  ...
  it('returns null for /api/auth/login', () => expect(getWorkspaceFromApiPath('/api/auth/login')).toBeNull());
  it('returns os for /api/tasks', () => expect(getWorkspaceFromApiPath('/api/tasks')).toBe('os'));
  it('returns os for /api/clients/123', () => expect(getWorkspaceFromApiPath('/api/clients/123')).toBe('os'));
});
...
describe('mapWorkspaceRoleToUserRole', () => {
  ...
  it('maps member to team_member', () => expect(mapWorkspaceRoleToUserRole('member')).toBe('team_member'));
  it('maps viewer to viewer', () => expect(mapWorkspaceRoleToUserRole('viewer')).toBe('viewer'));
  it('maps null to team_member', () => expect(mapWorkspaceRoleToUserRole(null)).toBe('team_member'));
});
...
describe('mapAccessRoleToWorkspaceRole', () => {
  ...
  it('maps team_member to member', () => expect(mapAccessRoleToWorkspaceRole('team_member')).toBe('member'));
  it('maps unknown to member', () => expect(mapAccessRoleToWorkspaceRole('unknown')).toBe('member'));
});
