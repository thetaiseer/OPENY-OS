    ...
    <div className="space-y-4">
      ...
      {content.length === 0 ? (
        <div className="py-16 text-center space-y-2">
          <FileText size={32} className="mx-auto opacity-30" style={{ color: 'var(--text-secondary)' }} />
          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>No content yet. Create your first content item.</p>
        </div>
      ) : (
        <div className="space-y-3">
          {content.map(item => (
