...
// ============================================================
// OPENY OS – Invitation Acceptance Page
// ============================================================
...
type PageState =
  | { phase: "loading" }
  | { phase: "invalid" }
  | { phase: "expired"; invitation: Invitation }
  | { phase: "already_accepted"; invitation: Invitation }
  | { phase: "cancelled"; invitation: Invitation }
  | { phase: "ready"; invitation: Invitation }
  | { phase: "accepting" }
  | { phase: "success"; invitation: Invitation };
    ...
    try {
      ...
      if (result.success && result.invitation) {
        ...
        await pushNotification(
          "invite_accepted",
          "Invitation Accepted",
          `${inv.name || inv.email} joined as ${inv.role}`,
          inv.id
        );
