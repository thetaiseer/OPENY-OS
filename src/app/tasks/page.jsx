...
{ value: "all", label: pageText("All", "الكل") },
{ value: "todo", label: pageText("To do", "للعمل") },
{ value: "in-progress", label: pageText("In progress", "قيد التنفيذ") },
{ value: "done", label: pageText("Done", "مكتمل") }];
...
function TaskRow({ task, isArabic, priorityColor, onEdit, onDelete, onToggle }) {
