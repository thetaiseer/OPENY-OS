...
> = {
  ...
  task_assigned:           { label: "Task",        dot: "#fbbf24" },
  ...
  approval_requested:      { label: "Approval",    dot: "#f97316" },
  approval_received:       { label: "Approval",    dot: "#34d399" },
  content_approved:        { label: "Content",     dot: "#34d399" },
  ...
  publishing_failed:       { label: "Publishing",  dot: "#f87171" },
  post_published:          { label: "Publishing",  dot: "#10b981" },
  client_approved:         { label: "Client",      dot: "#34d399" },
