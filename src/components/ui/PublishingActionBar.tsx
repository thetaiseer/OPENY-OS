...
import type { ContentItem, FailureReason } from "@/lib/types";

interface Props {
  item: ContentItem;
}

export function PublishingActionBar({ item }: Props) {
  ...
  const handleFailed = async (reason: FailureReason, note: string) => {
